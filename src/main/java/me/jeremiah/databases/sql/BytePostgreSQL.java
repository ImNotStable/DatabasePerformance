...
public class BytePostgreSQL extends PostgreSQL {

  public BytePostgreSQL() {
    super();

    setCreateTableStatement("CREATE TABLE entries (id INT PRIMARY KEY, data BYTEA)");
